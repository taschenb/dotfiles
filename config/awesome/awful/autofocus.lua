...
local function check_focus(obj)
    ...
    if not client.focus or not client.focus:isvisible() then
        ...
        -- Don't focus mpv, since it should be running sticky and on-top in a
        -- corner of the screen.
        -- Switching tag would always focus mpv, that wouldn't be very useful.
        if c and c.class=="mpv" then
            c = aclient.focus.history.get(obj.screen, 1)
        end
