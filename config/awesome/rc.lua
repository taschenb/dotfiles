...
-- Battey widget https://github.com/koenwtje/awesome-batteryInfo
...
globalkeys = awful.util.table.join(
    ...
    -- Touchpad
    awful.key({ }, "XF86TouchpadToggle", function () awful.util.spawn("synclient TouchpadOff=$(synclient -l | grep -c 'TouchpadOff.*=.*0')", false) end)
)
